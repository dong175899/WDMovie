 ...
 * 功能：
 **/
public class MyPriceMoVieAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context context;
    List<PriceMovieBean.ResultBean> result;
    public MyPriceMoVieAdapter(Context context, List<PriceMovieBean.ResultBean> result) {
