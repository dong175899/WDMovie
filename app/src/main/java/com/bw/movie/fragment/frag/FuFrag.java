...
import com.bw.movie.adapter.MyFuAdapter;
 ...
 * 功能：
 **/
public class FuFrag extends BaseFragment implements HomeContract.Iview {
    ...
    protected void initData() {
        ...
        homePresenter.getFuJiPresenter(userId,sessionId,"1","10");
    ...
    public void onFujiSuccess(FuJiBean data) {
        List<FuJiBean.ResultBean> result = data.getResult();
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getContext());
        tui_recycler.setLayoutManager(linearLayoutManager);
        MyFuAdapter myFuAdapter = new MyFuAdapter(getActivity(),result);
        tui_recycler.setAdapter(myFuAdapter);
    }
